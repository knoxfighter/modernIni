...
namespace {
	...
	TEST(EqualOpTests, NonIntrusiveStruct) {
		object obj{
			"5",
			1.5f,
			-10,
	...
	TEST(EqualOpTests, IntrusiveStruct) {
		objectIntrusive obj{
			"5",
			1.5f,
			-10,
	...
	TEST(EqualOpTests, NonIntrusiveStructMissingValues) {
		object obj{
			"5",
			1.5f,
			51,
	...
	TEST(EqualOpTests, OptionalInStruct) {
		Ini iniTest{
			IniMap {
				{"s2", Ini("s2", "huhu")}
			}
